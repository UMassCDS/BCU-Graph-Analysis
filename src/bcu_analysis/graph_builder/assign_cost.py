...
dataFolder = os.getenv('DATA_FOLDER', './data')
...
    
    cost_csv_path = f"{dataFolder}/parameters/Cost first draft.csv" 
...
    out_path = f"{dataFolder}/processed/osm/{city}_6_cost_simplified.graphml"
